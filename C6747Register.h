/*****************************************************************************************************
* FileName:                    C6747Register.h
*
* Description:                 6747寄存器定义
*
...
*****************************************************************************************************/
#ifndef _C6747_Register_H_
#define _C6747_Register_H_
...
typedef struct
{
    ...
    VUint32 SDCFG2;// 0x1C
    VUint32 BPRIO;// 0x20
    VUint8  RSVD2[28];// 0x24
    VUint32 PC1;// 0x40
    VUint32 PC2;// 0x44
    VUint32 PCC;// 0x48
    VUint32 PCMRS;// 0x4C
    VUint32 PCT;// 0x50
    VUint8  RSVD3[108];// 0x54
    VUint32 IRR;// 0xC0
    VUint32 IMR;// 0xC4
    VUint32 IMSR;// 0xC8
    VUint32 IMCR;// 0xCC
...
typedef struct
{
    VUint32 EVTFLAG[4];// 0x00
    VUint8  RSVD0[16];// 0x10
    VUint32 EVTSET[4];// 0x20
    VUint8  RSVD1[16];// 0x30
    VUint32 EVTCLR[4];// 0x40
    VUint8  RSVD2[48];// 0x50
    VUint32 EVTMASK[4];// 0x80
    VUint8  RSVD3[16];// 0x90
    VUint32 MEVTFLAG[4];// 0xA0
    VUint8  RSVD4[16];// 0xB0
    VUint32 EXPMASK[4];// 0xC0
    VUint8  RSVD5[16];// 0xD0
    VUint32 MEXPFLAG[4];// 0xE0
    VUint8  RSVD6[20];// 0xF0
    VUint32 INTMUX1;// 0x104
    VUint32 INTMUX2;// 0x108
    VUint32 INTMUX3;// 0x10C
    VUint8  RSVD7[48];// 0x110
    VUint32 AEGMUX0;// 0x140
    VUint32 AEGMUX1;// 0x144
    VUint8  RSVD8[56];// 0x148
...
//----------------------------------------------------------------------------------------------------
// Control Registers - See spru187.pdf, Chapter 6 for more details.
//----------------------------------------------------------------------------------------------------
extern cregister volatile unsigned int AMR;
extern cregister volatile unsigned int CSR;
extern cregister volatile unsigned int DESR;
extern cregister volatile unsigned int DETR;
