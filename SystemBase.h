...
// 本地结构声明
//====================================================================================================
typedef int32 (*INITIAL_FUNCTION)();
...
// SYSCFG
//----------------------------------------------------------------------------------------------------
#define pSYSCFG ((SYSCFG_REGS *)0x01C14000u)
...
#define pPSC0 ((PSC_REGS *)0x01C10000u)
#define pPSC1 ((PSC_REGS *)0x01E27000u)

//----------------------------------------------------------------------------------------------------
// EMIF
//----------------------------------------------------------------------------------------------------
#define pEMIFA ((EMIFA_REGS *) 0x68000000u)
#define pEMIFB ((EMIFB_REGS *) 0xB0000000u)
...
#define PLL0_PLLDIV1        0u
#define PLL0_PLLDIV2        1u
#define PLL0_PLLDIV3        1u//(2)EMIFA CLOCK =100MHZ,(5)EMIFA CLOCK =50MHZ,(29)EMIFA CLOCK =10MHZ,
#define PLL0_PLLDIV4        3u
#define PLL0_PLLDIV5        1u//EMIFB CLOCK =
#define PLL0_PLLDIV7        5u//EMAC/MDIO CLOCK =

#define FREQ_PLL0_PRE_ORG   (OSCIN * (PLL0_MULTIPLIER + 1u))
#define FREQ_PLL0_POST_ORG  (FREQ_PLL0_PRE_ORG / (PLL0_POSTDIV + 1u))
...
#define FREQ_PLL0_CLK4DOT5  ((float)((float)FREQ_PLL0_PRE_ORG / 4.5))

#define SYSCFG_CHIP3_CFG      0x0000FF05u
#define EMIFB_SDRAM_FREQ      FREQ_PLL0_CLK4DOT5

#define EMIFB_SDRAM_INTERVAL  ((float)(1000.000 / (EMIFB_SDRAM_FREQ / 1000000.000)))

#define pPLL0 ((PLL_REGS *)0x01c11000u)
...
// Interrupt Control
//----------------------------------------------------------------------------------------------------
#define pINTC ((INTC_REGS *)0x01800000u)
...
#define pSPI1 ((SPI_REGS *)0x01E12000u)
...
// GPIO Module
//----------------------------------------------------------------------------------------------------
#define pGPIO ((GPIO_REGS *)0x01E26000u)
...
// Edma Module
//----------------------------------------------------------------------------------------------------
#define pEDMA3CC   ((EDMA3CC_REGS *)0x01C00000u)
#define pEDMA3TC0  ((EDMA3TC_REGS *)0x01C08000u)
#define pEDMA3TC1  ((EDMA3TC_REGS *)0x01C08400u)
...
// flash存储空间分配
//----------------------------------------------------------------------------------------------------
#define FLASH_APP_START_ADDR          (0u)
#define FLASH_APP_LENGTH              (1u * 1024u * 1024u)
#define FLASH_APP_END_ADDR            (FLASH_APP_START_ADDR + FLASH_APP_LENGTH - 1u)

#define FLASH_FPGA_START_ADDR         (1u * 1024u * 1024u)
#define FLASH_FPGA_LENGTH             (1u * 1024u * 1024u)
#define FLASH_FPGA_END_ADDR           (FLASH_FPGA_START_ADDR + FLASH_FPGA_LENGTH - 1u)

#define FLASH_DEV_CFG_START_ADDR      (2u * 1024u * 1024u)
#define FLASH_DEV_CFG_LENGTH          (1024u * 1024u)
#define FLASH_DEV_CFG_END_ADDR        (FLASH_DEV_CFG_START_ADDR + FLASH_DEV_CFG_LENGTH - 1u)

#define FLASH_PRJ_CFG_START_ADDR      (3u * 1024u * 1024u)
#define FLASH_PRJ_CFG_LENGTH          ((1024u - 192u) * 1024u)
#define FLASH_PRJ_CFG_END_ADDR        (FLASH_PRJ_CFG_START_ADDR + FLASH_PRJ_CFG_LENGTH - 1u)

#define FLASH_ARG_COMM_START_ADDR     (4u * 1024u * 1024u - 192 * 1024u)
#define FLASH_ARG_COMM_LENGTH         (4u * 1024u)
#define FLASH_ARG_COMM_END_ADDR       (FLASH_ARG_COMM_START_ADDR + FLASH_ARG_COMM_LENGTH - 1u)

#define FLASH_ARG_SYS_START_ADDR      (4u * 1024u * 1024u - 192 * 1024u + 4u * 1024u)
#define FLASH_ARG_SYS_LENGTH          (4u * 1024u)
#define FLASH_ARG_SYS_END_ADDR        (FLASH_ARG_SYS_START_ADDR + FLASH_ARG_SYS_LENGTH - 1u)

#define FLASH_ARG_VBI_START_ADDR      (4u * 1024u * 1024u - 192 * 1024u + 8u * 1024u)
#define FLASH_ARG_VBI_LENGTH          (4u * 1024u)
#define FLASH_ARG_VBI_END_ADDR        (FLASH_ARG_VBI_START_ADDR + FLASH_ARG_VBI_LENGTH - 1u)

#define FLASH_ARG_DEV_START_ADDR      (4u * 1024u * 1024u - 192 * 1024u + 12u * 1024u)
#define FLASH_ARG_DEV_LENGTH          (4u * 1024u)
#define FLASH_ARG_DEV_END_ADDR        (FLASH_ARG_DEV_START_ADDR + FLASH_ARG_DEV_LENGTH - 1u)

#define FLASH_ARG_PROT_START_ADDR     (4u * 1024u * 1024u - 192 * 1024u + 32u * 1024u)
#define FLASH_ARG_PROT_LENGTH         (64u * 1024u)
#define FLASH_ARG_PROT_END_ADDR       (FLASH_ARG_PROT_START_ADDR + FLASH_ARG_PROT_LENGTH - 1u)

#define SELF_BIN_HEADER_LENGTH        16u
#define SELF_BIN_VERSION              1u

//----------------------------------------------------------------------------------------------------
// 中断相关定义
//----------------------------------------------------------------------------------------------------
#define PRIORITY_EDMA_INTERRUPT        10u
#define ENABLE_INTERRUPT_EDMA          (IER |= (1u << PRIORITY_EDMA_INTERRUPT))
#define DISABLE_INTERRUPT_EDMA         (IER &= (~(1u << PRIORITY_EDMA_INTERRUPT)))
#define CLR_INTERRUPT_FLAG_EDMA        (ICR = (1u << PRIORITY_EDMA_INTERRUPT))
...
#define PRIORITY_COMMUNICATION_INTERRUPT 12u
#define ENABLE_INTERRUPT_COMMUNICATION   (IER |= (1u << PRIORITY_COMMUNICATION_INTERRUPT))
#define DISABLE_INTERRUPT_COMMUNICATION  (IER &= (~(1u << PRIORITY_COMMUNICATION_INTERRUPT)))
#define CLR_INTERRUPT_FLAG_COMMUNICATION (ICR = (1u << PRIORITY_COMMUNICATION_INTERRUPT))

#define PRIORITY_PPS_INTERRUPT           8u
#define ENABLE_INTERRUPT_PPS             (IER |= (1u << PRIORITY_PPS_INTERRUPT))
#define DISABLE_INTERRUPT_PPS            (IER &= (~(1u << PRIORITY_PPS_INTERRUPT)))
#define CLR_INTERRUPT_FLAG_PPS           (ICR = (1u << PRIORITY_PPS_INTERRUPT))
#define INTERRUPT_FLAG_PPS               (IFR & (1u << PRIORITY_PPS_INTERRUPT))

#define COMMUNICATION_INTERRUPT_TRIGGER_MANUALLY (ISR = (1u << PRIORITY_COMMUNICATION_INTERRUPT))
...
extern int32 ParameterReadFromFlash(Uint8 parameter_type);
extern int32 ParameterWriteToFlash(Uint8 parameter_type);
extern VUint32 system_ms_count;
extern VUint64 system_local_usecond;
extern VUint8  system_run_status;
...
extern Uint16 SpiContentCrcCal(Uint32 addr, int32 length);
extern void DelayLoop(Uint32 loopcnt);
extern void DelayLoopAccurate(Uint32 loopcnt);
extern int32 InterruptRegister(INTERRUPT_FUNCTION interrupt_function, Uint8 priority, Uint8 interrupt_src_num, int8 interrupt_enable_flag);
extern void EdmaInterruptService(void);
